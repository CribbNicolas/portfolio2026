...
| 2026-08-24 | `/cv` deja de ser destino: `noindex`, sin links entrantes, solo fuente de impresión del PDF | Es lo que siempre fue por debajo. Lo sostiene `single-landing.check.ts`, no la buena memoria |
